...
public class ReportsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            {
                try{
                    String jasperFilePath = context.getRealPath("reportesUsuarios/Usuarios.jasper"); //request.getSession().getServletContext().getRealPath("/reportesUsuarios/Usuarios.jrxml");
                    String jrxmlFilePath = context.getRealPath("reportesUsuarios/Usuarios.jrxml");
            ...
            }else if(action.equalsIgnoreCase("compilaConParametros"))
            {
                try{
                    ...
                    String jasperFilePath = context.getRealPath("reportesUsuarios/receta.jasper");//reportesUsuarios/categories.jasper"); //request.getSession().getServletContext().getRealPath("/reportesUsuarios/Usuarios.jrxml");
                    String jrxmlFilePath = context.getRealPath("reportesUsuarios/receta.jrxml");//reportesUsuarios/categories.jrxml");
                    File reportFile = new File(jasperFilePath);
                    // create a map of parameters to pass to the report.
                    Map<String,Object> parametros = new HashMap<String,Object>();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            }else if(action.equalsIgnoreCase("postConParametros"))
            {
                ...
                try{
                    ...
                    //}
                    String jasperFilePath = context.getRealPath("reportesUsuarios/receta.jasper");//Invoice.jasper"); //request.getSession().getServletContext().getRealPath("/reportesUsuarios/Usuarios.jrxml");
                    String jrxmlFilePath = context.getRealPath("reportesUsuarios/receta.jrxml");//Invoice.jrxml");
                    File reportFile = new File(jasperFilePath);
                    // create a map of parameters to pass to the report.
                    Map<String,Object> parametros = new HashMap<String,Object>();
                    parametros.put("ID_CAT", Integer.valueOf(idcategoria));
                  
                     //new Integer(idcategoria));//Si el tipo de dato es String y lo queremos pasar con integer ("CAT_ID", ""+idcategoria);
                    // If compiled file is not found, then compile XML template
                    if (!reportFile.exists()) 
                    {
                        // load JasperDesign from XML and compile it into JasperReport
